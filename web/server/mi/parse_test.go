...
func TestVersionParser(t *testing.T) {
	v, err := ParseVersion(responseVersion)
	assert.Nil(t, err)
...
func TestStatsParser(t *testing.T) {
	ls, err := ParseStats(responseLoadStats)
	assert.Nil(t, err)
...
func TestStatsParserError(t *testing.T) {
	_, err := ParseStats(responseLoadStatsBroken)
	assert.NotNil(t, err)
}

func TestStatsErrorStr(t *testing.T) {
	_, err := ParseStats(responseError)
	assert.NotNil(t, err)
}

func TestStatusParser(t *testing.T) {
	s, err := ParseStatus(responseStatus)
	assert.Nil(t, err)
	sExpected := &Status{
...
func TestKillSessionParser(t *testing.T) {
	m, err := ParseKillSession(responseKillSession)
	assert.Nil(t, err)
...
func TestKillSessionWrongNrOfLines(t *testing.T) {
	_, err := ParseKillSession("a\n\na")
	assert.NotNil(t, err)
}

func TestKillSessionResponseError(t *testing.T) {
	_, err := ParseKillSession(responseKillSessionError)
	assert.NotNil(t, err)
}
